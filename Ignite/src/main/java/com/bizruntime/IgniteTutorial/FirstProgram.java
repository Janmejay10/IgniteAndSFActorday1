package com.bizruntime.IgniteTutorial;
...
public class FirstProgram {
	public static void main(String[] args) {
		...
		Ignite objIgnite = Ignition.start("E:\\apache-ignite-fabric-2.6.0-bin\\apache-ignite-fabric-2.6.0-bin\\config\\itc-poc-config.xml");
